...
(function(AgendaProcessTimes) {
  ...
  (AgendaProcessTimes =
    exports.AgendaProcessTimes || (exports.AgendaProcessTimes = {}))
);
...
(function(AgendaTimeRanges) {
  ...
  (AgendaTimeRanges =
    exports.AgendaTimeRanges || (exports.AgendaTimeRanges = {}))
);
agenda.define(AgendaJobs.soloStreakCompleteForTimezoneTracker, (job, done) =>
  __awaiter(this, void 0, void 0, function*() {
    ...
    yield resetSoloStreaksNotCompletedTodayByTimezone_1.resetSoloStreaksNotCompletedTodayByTimezone(
      SoloStreak_1.soloStreakModel,
      getIncompleteSoloStreaks_1.getIncompleteSoloStreaks,
      resetIncompleteSoloStreaks_1.resetIncompleteSoloStreaks,
      timezone,
