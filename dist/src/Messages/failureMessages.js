...
(function(FailureMessageKeys) {
  ...
  (FailureMessageKeys =
    exports.FailureMessageKeys || (exports.FailureMessageKeys = {}))
);
exports.failureMessages = {
  [supportedLanguages_1.supportedLanguages.EN]: {
    ...
    [FailureMessageKeys.missingTimezoneHeaderMessage]: `Missing x-timezone header in request`,
    [FailureMessageKeys.invalidTimezoneMessage]: `Timezone is invalid`,
    [FailureMessageKeys.invalidTokenMessage]: "Invalid token",
    [FailureMessageKeys.missingJsonWebTokenMessage]:
      "JSON web token is missing from header",
