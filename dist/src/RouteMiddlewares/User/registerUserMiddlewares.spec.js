...
describe(`userRegistrationValidationMiddlware`, () => {
  ...
  test("check that valid request passes", () => {
    ...
    const next = jest.fn();
    registerUserMiddlewares_1.userRegistrationValidationMiddleware(
      request,
      response,
      next
    );
...
describe(`doesUserEmailExistMiddleware`, () => {
  ...
  test("should set emailExists to true when user is found", () =>
    __awaiter(this, void 0, void 0, function*() {
      ...
      const next = jest.fn();
      const middleware = registerUserMiddlewares_1.getDoesUserEmailExistMiddleware(
        UserModel
      );
  ...
  test("should set emailExists to false when user doesn't exist", () =>
    __awaiter(this, void 0, void 0, function*() {
...
describe(`emailExistsValidationMiddleware `, () => {
  ...
  test("check that error response is returned correctly when email already exists", () =>
    __awaiter(this, void 0, void 0, function*() {
      const send = jest.fn();
      const status = jest.fn(() => ({ send }));
      ...
      const next = jest.fn();
      const middleware = registerUserMiddlewares_1.getEmailExistsValidationMiddleware(
...
describe("setUserNameToLowercaseMiddleware", () => {
  ...
  test("it should set userName to lowercase version of itself", () => {
    ...
    const response = { locals: {} };
    const next = jest.fn();
    registerUserMiddlewares_1.setUserNameToLowercaseMiddleware(
      request,
      response,
      next
    );
...
describe(`doesUserNameExistMiddleware`, () => {
  const mockUserName = "testname";
  const ERROR_MESSAGE = "error";
  test("should set userNameExists to true when userExists", () =>
    __awaiter(this, void 0, void 0, function*() {
      const findOne = jest.fn(() => Promise.resolve(true));
      const UserModel = {
        findOne
      ...
      const next = jest.fn();
      const middleware = registerUserMiddlewares_1.getDoesUserNameExistMiddleware(
        UserModel
      );
      yield middleware(request, response, next);
      expect.assertions(3);
  ...
  test("should set userNameExists to false when user doesn't exist", () =>
    __awaiter(this, void 0, void 0, function*() {
      const findOne = jest.fn(() => Promise.resolve(false));
      const UserModel = {
        findOne
...
describe(`userNameExistsValidationMiddleware`, () => {
  ...
  test("check that error response is returned correctly when userName already exists", () => {
    ...
    const next = jest.fn();
    const middleware = registerUserMiddlewares_1.getUserNameExistsValidationMiddleware(
      generateAlreadyExistsMessage,
      subject,
      userNameKey
    );
...
describe(`hashPasswordMiddleware`, () => {
  const ERROR_MESSAGE = "error";
  test("should set response.locals.hashedPassword", () =>
    __awaiter(this, void 0, void 0, function*() {
      ...
      const middleware = registerUserMiddlewares_1.getHashPasswordMiddleware(
        hash,
        saltMock
      );
      const response = { locals: {} };
  ...
  test("should call next() with err paramater if hash password call fails", () =>
    __awaiter(this, void 0, void 0, function*() {
      const mockedPassword = "password";
      const hashedPassword = "12$4354";
      const saltMock = 10;
...
describe(`createUserFromRequestMiddleware`, () => {
  test("should define response.locals.newUser", () =>
    __awaiter(this, void 0, void 0, function*() {
      const hashedPassword = "12$4354";
      const userName = "user";
...
describe(`saveUserToDatabaseMiddleware`, () => {
  const ERROR_MESSAGE = "error";
  test("should set response.locals.savedUser", () =>
    __awaiter(this, void 0, void 0, function*() {
      const save = jest.fn(() => {
      ...
      const request = {};
      const next = jest.fn();
      yield registerUserMiddlewares_1.saveUserToDatabaseMiddleware(
        request,
        response,
        next
      );
...
describe(`sendFormattedUserMiddleware`, () => {
  ...
  test("should send user in response with password undefined", () => {
    ...
    const request = {};
    const next = jest.fn();
    registerUserMiddlewares_1.sendFormattedUserMiddleware(
      request,
      response,
      next
    );
...
describe(`verifyJsonWebTokenMiddlewaresWithResponse`, () => {
  test("that verfiyJsonWebToken middlewares are defined in the correct order", () => {
    ...
    expect(registerUserMiddlewares_1.registerUserMiddlewares[0]).toBe(
      registerUserMiddlewares_1.userRegistrationValidationMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[1]).toBe(
      registerUserMiddlewares_1.doesUserEmailExistMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[2]).toBe(
      registerUserMiddlewares_1.emailExistsValidationMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[3]).toBe(
      registerUserMiddlewares_1.setUserNameToLowercaseMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[4]).toBe(
      registerUserMiddlewares_1.doesUserNameExistMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[5]).toBe(
      registerUserMiddlewares_1.userNameExistsValidationMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[6]).toBe(
      registerUserMiddlewares_1.hashPasswordMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[7]).toBe(
      registerUserMiddlewares_1.createUserFromRequestMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[8]).toBe(
      registerUserMiddlewares_1.saveUserToDatabaseMiddleware
    );
    expect(registerUserMiddlewares_1.registerUserMiddlewares[9]).toBe(
      registerUserMiddlewares_1.sendFormattedUserMiddleware
    );
  });
});
