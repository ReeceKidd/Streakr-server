...
exports.getDoesUserEmailExistMiddleware = userModel => (
  request,
  response,
  next
) =>
...
exports.doesUserEmailExistMiddleware = exports.getDoesUserEmailExistMiddleware(
  User_1.userModel
);
exports.getEmailExistsValidationMiddleware = (
...
exports.emailExistsValidationMiddleware = exports.getEmailExistsValidationMiddleware(
  generateAlreadyExistsMessage_1.generateAlreadyExistsMessage,
  "User",
  keys_1.emailKey
);
...
exports.getDoesUserNameExistMiddleware = userModel => (
  request,
  response,
  next
) =>
...
exports.doesUserNameExistMiddleware = exports.getDoesUserNameExistMiddleware(
  User_1.userModel
);
exports.getUserNameExistsValidationMiddleware = (
...
exports.userNameExistsValidationMiddleware = exports.getUserNameExistsValidationMiddleware(
  generateAlreadyExistsMessage_1.generateAlreadyExistsMessage,
  "User",
  keys_1.userNameKey
);
exports.getHashPasswordMiddleware = (hash, saltRounds) => (
  request,
  response,
  next
) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      response.locals.hashedPassword = yield hash(password, saltRounds);
      next();
    } catch (err) {
      next(err);
    }
  });
exports.hashPasswordMiddleware = exports.getHashPasswordMiddleware(
  bcryptjs_1.hash,
  saltRounds_1.saltRounds
);
exports.getCreateUserFromRequestMiddleware = user => (
  request,
  response,
  next
) => {
...
exports.createUserFromRequestMiddleware = exports.getCreateUserFromRequestMiddleware(
  User_1.userModel
);
exports.saveUserToDatabaseMiddleware = (request, response, next) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
