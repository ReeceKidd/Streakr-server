...
describe(`soloStreakRegistrationValidationMiddlware`, () => {
  ...
  test("that minimum amount of information needed for a streak passes", () => {
    ...
    const next = jest.fn();
    createSoloStreakMiddlewares_1.soloStreakRegistrationValidationMiddleware(
      request,
      response,
      next
    );
...
describe("retreiveTimezoneHeaderMiddleware", () => {
  test("should define response.locals.timezone", () => {
    ...
    const request = {
      headers: {
        [headers_1.SupportedRequestHeaders.xTimezone]: londonTimezone
      },
      header
    };
    const response = {
    ...
    const next = jest.fn();
    createSoloStreakMiddlewares_1.retreiveTimezoneHeaderMiddleware(
      request,
      response,
      next
    );
...
describe("sendMissingTimezoneErrorResponseMiddleware", () => {
  ...
  test("that next() is called when timezone is defined", () => {
    ...
    const middleware = createSoloStreakMiddlewares_1.getSendMissingTimezoneErrorResponseMiddleware(
...
describe("validateTimezoneMiddleware", () => {
  ...
  test("that response.locals.validTimezone is defined when timezone exists", () => {
    ...
    const next = jest.fn();
    const middleware = createSoloStreakMiddlewares_1.getValidateTimezoneMiddleware(
      isValidTimezone
    );
    middleware(request, response, next);
...
describe("sendInvalidTimezoneErrorResponseMiddleware", () => {
  test("that next() is called when time zone is valid", () => {
    ...
    const next = jest.fn();
    const localisedErrorMessage = "Error";
    const middleware = createSoloStreakMiddlewares_1.getSendInvalidTimezoneErrorResponseMiddleware(
      localisedErrorMessage
    );
    middleware(request, response, next);
    expect.assertions(1);
...
describe("defineCurrentTimeMiddleware", () => {
  test("that response.locals.currentTime is defined and next is called", () => {
    ...
    const next = jest.fn();
    const middleware = createSoloStreakMiddlewares_1.getDefineCurrentTimeMiddleware(
      moment
    );
    middleware(request, response, next);
...
describe("defineStartDayMiddleware", () => {
  test("that response.locals.startDay is defined and next() is called", () => {
    ...
    const next = jest.fn();
    const middleware = createSoloStreakMiddlewares_1.getDefineStartDayMiddleware(
      dayFormat
    );
    middleware(request, response, next);
...
describe("defineEndOfDayMiddleware", () => {
  test("that response.locals.endOfDay is defined", () => {
    ...
    const middleware = createSoloStreakMiddlewares_1.getDefineEndOfDayMiddleware(
      dayTimeRange
    );
    middleware(request, response, next);
...
describe(`createSoloStreakFromRequestMiddleware`, () => {
  test("should define response.locals.newSoloStreak", () =>
...
describe(`saveSoloStreakToDatabaseMiddleware`, () => {
  ...
  test("should set response.locals.savedSoloStreak", () =>
    __awaiter(this, void 0, void 0, function*() {
      const save = jest.fn(() => {
      ...
      const request = {};
      const next = jest.fn();
      yield createSoloStreakMiddlewares_1.saveSoloStreakToDatabaseMiddleware(
        request,
        response,
        next
      );
  ...
  test("should call next() with err paramater if save call fails", () =>
    __awaiter(this, void 0, void 0, function*() {
      const save = jest.fn(() => {
...
describe(`sendFormattedSoloStreakMiddleware`, () => {
  ...
  test("should send user in response with password undefined", () => {
    ...
    const request = {};
    const next = jest.fn();
    createSoloStreakMiddlewares_1.sendFormattedSoloStreakMiddleware(
      request,
      response,
      next
    );
...
describe(`createSoloStreakMiddlewares`, () => {
  test("that createSoloStreak middlewares are defined in the correct order", () =>
    __awaiter(this, void 0, void 0, function*() {
      expect.assertions(12);
      expect(
        createSoloStreakMiddlewares_1.createSoloStreakMiddlewares.length
      ).toEqual(11);
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[0]).toBe(
        createSoloStreakMiddlewares_1.soloStreakRegistrationValidationMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[1]).toBe(
        createSoloStreakMiddlewares_1.retreiveTimezoneHeaderMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[2]).toBe(
        createSoloStreakMiddlewares_1.sendMissingTimezoneErrorResponseMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[3]).toBe(
        createSoloStreakMiddlewares_1.validateTimezoneMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[4]).toBe(
        createSoloStreakMiddlewares_1.sendInvalidTimezoneErrorResponseMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[5]).toBe(
        createSoloStreakMiddlewares_1.defineCurrentTimeMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[6]).toBe(
        createSoloStreakMiddlewares_1.defineStartDayMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[7]).toBe(
        createSoloStreakMiddlewares_1.defineEndOfDayMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[8]).toBe(
        createSoloStreakMiddlewares_1.createSoloStreakFromRequestMiddleware
      );
      expect(createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[9]).toBe(
        createSoloStreakMiddlewares_1.saveSoloStreakToDatabaseMiddleware
      );
      expect(
        createSoloStreakMiddlewares_1.createSoloStreakMiddlewares[10]
      ).toBe(createSoloStreakMiddlewares_1.sendFormattedSoloStreakMiddleware);
    }));
});
