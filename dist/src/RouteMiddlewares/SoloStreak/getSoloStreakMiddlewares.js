...
exports.getRetreiveSoloStreakMiddleware = soloStreakModel => (
  request,
  response,
  next
) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      response.locals.soloStreak = yield soloStreakModel
...
exports.retreiveSoloStreakMiddleware = exports.getRetreiveSoloStreakMiddleware(
...
exports.getSendSoloStreakMiddleware = resourceCreatedResponseCode => (
  request,
  response,
  next
) => {
  try {
    ...
    return response
      ...
      .send(Object.assign({}, soloStreak));
  } catch (err) {
    next(err);
  }
};
exports.sendSoloStreakMiddleware = exports.getSendSoloStreakMiddleware(
