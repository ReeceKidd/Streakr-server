...
describe("soloStreakParamsValidationMiddleware", () => {
    test("that correct response is sent when soloStreakId is not defined", () => {
        ...
        const next = jest.fn();
        patchSoloStreakMiddlewares_1.soloStreakParamsValidationMiddleware(request, response, next);
        expect.assertions(3);
...
describe("soloStreakRequestBodyValidationMiddleware", () => {
    test("that unsupported key cannot be sent in body", () => {
        ...
        const next = jest.fn();
        patchSoloStreakMiddlewares_1.soloStreakRequestBodyValidationMiddleware(request, response, next);
        expect.assertions(3);
...
describe("patchSoloStreakMiddleware", () => {
    test("that response.locals.updatedSoloStreak is defined and next is called", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(3);
        ...
        const middleware = patchSoloStreakMiddlewares_1.getPatchSoloStreakMiddleware(soloStreakModel);
...
describe("soloStreakDoesNotExistErrorMessageMiddleware", () => {
    test("that error response is sent when response.locals.updatedSoloStreak is not defined", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(3);
        const send = jest.fn();
        const status = jest.fn(() => ({ send }));
        const request = {};
        ...
        const middleware = patchSoloStreakMiddlewares_1.getSoloStreakDoesNotExistErrorMessageMiddleware(unprocessableEntityStatus, localisedErrorMessage);
    ...
    test("that next() is called when response.locals.updatedSoloStreak is defined", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(1);
...
describe("sendUpdatedPatchMiddleware", () => {
    ...
    test("should send user in response with password undefined", () => {
        ...
        const middleware = patchSoloStreakMiddlewares_1.getSendUpdatedSoloStreakMiddleware(updatedResourceResponseCode);
        middleware(request, response, next);
        expect.assertions(4);
...
describe("patchSoloStreakMiddlewares", () => {
    test("that patchSoloStreakMiddlewares are defined in the correct order", () => {
        expect.assertions(5);
        expect(patchSoloStreakMiddlewares_1.patchSoloStreakMiddlewares[0]).toBe(patchSoloStreakMiddlewares_1.soloStreakParamsValidationMiddleware);
        expect(patchSoloStreakMiddlewares_1.patchSoloStreakMiddlewares[1]).toBe(patchSoloStreakMiddlewares_1.soloStreakRequestBodyValidationMiddleware);
        expect(patchSoloStreakMiddlewares_1.patchSoloStreakMiddlewares[2]).toBe(patchSoloStreakMiddlewares_1.patchSoloStreakMiddleware);
        expect(patchSoloStreakMiddlewares_1.patchSoloStreakMiddlewares[3]).toBe(patchSoloStreakMiddlewares_1.soloStreakDoesNotExistErrorMessageMiddleware);
        expect(patchSoloStreakMiddlewares_1.patchSoloStreakMiddlewares[4]).toBe(patchSoloStreakMiddlewares_1.sendUpdatedSoloStreakMiddleware);
    });
});
