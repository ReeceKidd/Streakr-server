...
exports.getDeleteSoloStreakMiddleware = (soloStreakModel) => (request, response, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        const { soloStreakId } = request.params;
        const deletedSoloStreak = yield soloStreakModel.findByIdAndDelete(soloStreakId);
...
exports.deleteSoloStreakMiddleware = exports.getDeleteSoloStreakMiddleware(SoloStreak_1.soloStreakModel);
exports.getSoloStreakNotFoundMiddleware = (badRequestResponseCode, localisedSoloStreakDoesNotExistErrorMessage) => (request, response, next) => {
    try {
...
exports.soloStreakNotFoundMiddleware = exports.getSoloStreakNotFoundMiddleware(responseCodes_1.ResponseCodes.badRequest, localisedSoloStreakDoesNotExistErrorMessage);
exports.getSendSoloStreakDeletedResponseMiddleware = (successfulDeletetionResponseCode) => (request, response, next) => {
    try {
...
exports.sendSoloStreakDeletedResponseMiddleware = exports.getSendSoloStreakDeletedResponseMiddleware(responseCodes_1.ResponseCodes.deleted);
