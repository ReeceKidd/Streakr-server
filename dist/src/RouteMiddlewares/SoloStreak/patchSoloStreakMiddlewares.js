...
exports.getPatchSoloStreakMiddleware = soloStreakModel => (
  request,
  response,
  next
) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
      ...
      const updatedSoloStreak = yield soloStreakModel.findByIdAndUpdate(
        soloStreakId,
        Object.assign({}, keysToUpdate),
        { new: true }
      );
...
exports.getSoloStreakDoesNotExistErrorMessageMiddleware = (
  badRequestReponseCode,
...
exports.soloStreakDoesNotExistErrorMessageMiddleware = exports.getSoloStreakDoesNotExistErrorMessageMiddleware(
  responseCodes_1.ResponseCodes.badRequest,
  localisedSoloStreakDoesNotExistErrorMessage
);
exports.getSendUpdatedSoloStreakMiddleware = updatedResourceResponseCode => (
  request,
  response,
  next
) => {
...
exports.sendUpdatedSoloStreakMiddleware = exports.getSendUpdatedSoloStreakMiddleware(
  responseCodes_1.ResponseCodes.success
);
exports.patchSoloStreakMiddleware = exports.getPatchSoloStreakMiddleware(
