...
describe(`loginRequestValidationMiddlware`, () => {
    ...
    test("check that valid request passes", () => {
        ...
        const next = jest.fn();
        loginMiddlewares_1.loginRequestValidationMiddleware(request, response, next);
        expect.assertions(1);
...
describe(`retreiveUserWithEmailMiddleware`, () => {
    ...
    test("should define response.locals.user when user is found", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getRetreiveUserWithEmailMiddleware(UserModel);
    ...
    test("should not define response.locals.user when user doesn't exist", () => __awaiter(this, void 0, void 0, function* () {
...
describe(`userExistsValidationMiddleware`, () => {
    ...
    test("check that error response is returned correctly when user wasn't found", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getUserExistsValidationMiddleware(mockErrorMessage);
...
describe(`compareRequestPasswordToUserHashedPasswordMiddleware`, () => {
    ...
    test("should set response.locals.passwordMatchesHash to true when the request password matches the user hash", () => __awaiter(this, void 0, void 0, function* () {
        const compare = jest.fn(() => {
            return Promise.resolve(true);
        });
        const middleware = loginMiddlewares_1.getCompareRequestPasswordToUserHashedPasswordMiddleware(compare);
    ...
    test("should set response.locals.passwordMatchesHash to false when the request password does not match the user hash", () => __awaiter(this, void 0, void 0, function* () {
        const compare = jest.fn(() => {
    ...
    test("should call next() with err paramater if compare fails", () => __awaiter(this, void 0, void 0, function* () {
        const compare = jest.fn(() => {
...
describe(`passwordsMatchValidationMiddleware`, () => {
    ...
    const errorMessage = "error";
    test("check that error response is returned correctly when passwords don't match", () => __awaiter(this, void 0, void 0, function* () {
        const send = jest.fn();
        const status = jest.fn(() => ({ send }));
        const request = {};
        const response = {
        ...
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getPasswordsMatchValidationMiddleware(loginError);
        yield middleware(request, response, next);
        expect.assertions(2);
        expect(status).toHaveBeenCalledWith(responseCodes_1.ResponseCodes.badRequest);
...
describe("setJsonWebTokenExpiryInfoMiddleware", () => {
    test("response.locals.expiry should be populated with next called", () => {
        ...
        const response = { locals: {} };
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getSetJsonWebTokenExpiryInfoMiddleware(expiresIn, unitOfTime);
        middleware(request, response, next);
...
describe("setJsonWebTokenMiddleware", () => {
    ...
    test("should set response.locals.token", () => {
        ...
        const request = {};
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getSetJsonWebTokenMiddleware(signTokenMock, jwtSecretMock);
        middleware(request, response, next);
        expect.assertions(3);
...
describe(`loginSuccessfulMiddleware`, () => {
    ...
    test("should send login success message", () => {
        ...
        const request = {};
        const next = jest.fn();
        const middleware = loginMiddlewares_1.getLoginSuccessfulMiddleware(loginSuccessMessage);
        middleware(request, response, next);
        expect.assertions(3);
        expect(next).not.toBeCalled();
...
describe(`loginMiddlewares`, () => {
    test("that login middlewares are defined in the correct order", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(9);
        expect(loginMiddlewares_1.loginMiddlewares[0]).toBe(loginMiddlewares_1.loginRequestValidationMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[1]).toBe(loginMiddlewares_1.retreiveUserWithEmailMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[2]).toBe(loginMiddlewares_1.userExistsValidationMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[3]).toBe(loginMiddlewares_1.compareRequestPasswordToUserHashedPasswordMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[4]).toBe(loginMiddlewares_1.passwordsMatchValidationMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[5]).toBe(loginMiddlewares_1.setMinimumUserDataMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[6]).toBe(loginMiddlewares_1.setJsonWebTokenExpiryInfoMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[7]).toBe(loginMiddlewares_1.setJsonWebTokenMiddleware);
        expect(loginMiddlewares_1.loginMiddlewares[8]).toBe(loginMiddlewares_1.loginSuccessfulMiddleware);
    }));
});
