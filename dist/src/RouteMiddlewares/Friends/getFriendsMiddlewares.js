...
exports.getRetreiveFriendsMiddleware = userModel => (request, response, next) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
      const { user } = response.locals;
      const { friends } = user;
      response.locals.friends = yield Promise.all(
...
exports.retreiveFriendsMiddleware = exports.getRetreiveFriendsMiddleware(
  User_1.userModel
);
