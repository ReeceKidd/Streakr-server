...
describe("addFriendParamsValidationMiddleware", () => {
    ...
    test("that valid request passes", () => {
        ...
        const next = jest.fn();
        addFriendMiddlewares_1.addFriendParamsValidationMiddleware(request, response, next);
...
describe("addFriendBodyValidationMiddleware", () => {
    ...
    test("that valid request passes", () => {
        ...
        const next = jest.fn();
        addFriendMiddlewares_1.addFriendBodyValidationMiddleware(request, response, next);
        expect.assertions(1);
        expect(next).toBeCalledWith();
    });
...
describe(`retreiveUserMiddleware`, () => {
    ...
    test("should define response.locals.user when user is found", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const next = jest.fn();
        const middleware = addFriendMiddlewares_1.getRetreiveUserMiddleware(UserModel);
...
describe(`userExistsValidationMiddleware`, () => {
    ...
    test("check that error response is returned correctly when user wasn't found", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const next = jest.fn();
        const middleware = addFriendMiddlewares_1.getUserExistsValidationMiddleware(mockErrorMessage);
...
describe("addFriendMiddleware", () => {
    ...
    const mockFriendId = "2345";
    test("that friendId gets added to the users friends array correctly", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const next = jest.fn();
        const middleware = addFriendMiddlewares_1.getAddFriendMiddleware(UserModel);
        yield middleware(request, response, next);
        expect.assertions(2);
...
describe("retreiveFriendsDetailsMiddleware", () => {
    const friendId = "abcd";
    test("that response.locals.friends is populated with friends details", () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(3);
        ...
        const middleware = addFriendMiddlewares_1.getRetreiveFriendsDetailsMiddleware(userModel);
        yield middleware(request, response, next);
...
describe("defineLocationPathMiddleware", () => {
    test("that response.locals.locationPath is defined correctly", () => {
        ...
        const middleware = addFriendMiddlewares_1.getDefineLocationPathMiddleware(apiVersion, userCategory, friendsProperty);
        middleware(request, response, next);
...
describe("setLocationHeaderMiddleware", () => {
    test("that location header is set correctly", () => {
        ...
        const next = jest.fn();
        const middleware = addFriendMiddlewares_1.getSetLocationHeaderMiddleware(headers_1.SupportedResponseHeaders.location);
        middleware(request, response, next);
        expect.assertions(2);
        expect(setHeader).toHaveBeenCalledWith(headers_1.SupportedResponseHeaders.location, locationPath);
        expect(next).toBeCalled();
    });
    test("that next is called with error on failure", () => {
        const request = {
...
describe("sendFriendAddedSuccessMessageMiddleware", () => {
    test("that response sends success message inside of object", () => {
        ...
        const request = {};
        const next = jest.fn();
        const middleware = addFriendMiddlewares_1.getSendFriendAddedSuccessMessageMiddleware(successMessage);
        middleware(request, response, next);
        expect.assertions(3);
        expect(next).not.toBeCalled();
...
describe("addFriendMiddlewares", () => {
    test("that middlewares are defined in the correct order", () => {
        ...
        expect(addFriendMiddlewares_1.addFriendMiddlewares[0]).toBe(addFriendMiddlewares_1.addFriendParamsValidationMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[1]).toBe(addFriendMiddlewares_1.addFriendBodyValidationMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[2]).toBe(addFriendMiddlewares_1.retreiveUserMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[3]).toBe(addFriendMiddlewares_1.userExistsValidationMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[4]).toBe(addFriendMiddlewares_1.addFriendMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[5]).toBe(addFriendMiddlewares_1.retreiveFriendsDetailsMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[6]).toBe(addFriendMiddlewares_1.formatFriendsMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[7]).toBe(addFriendMiddlewares_1.defineLocationPathMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[8]).toBe(addFriendMiddlewares_1.setLocationHeaderMiddleware);
        expect(addFriendMiddlewares_1.addFriendMiddlewares[9]).toBe(addFriendMiddlewares_1.sendFriendAddedSuccessMessageMiddleware);
    });
});
