...
exports.getAddFriendMiddleware = userModel => (request, response, next) =>
  __awaiter(this, void 0, void 0, function*() {
    try {
      const { userId } = request.params;
      const { friendId } = request.body;
      const updatedUser = yield userModel.findOneAndUpdate(
        { _id: userId },
...
exports.getRetreiveFriendsDetailsMiddleware = userModel => (
  request,
  response,
  next
) =>
...
exports.retreiveFriendsDetailsMiddleware = exports.getRetreiveFriendsDetailsMiddleware(
  User_1.userModel
);
...
exports.getDefineLocationPathMiddleware = (
  apiVersion,
  userCategory,
  friendsProperty
...
exports.defineLocationPathMiddleware = exports.getDefineLocationPathMiddleware(
  versions_1.default.v1,
  routeCategories_1.RouteCategories.users,
  routeCategories_1.UserProperties.friends
);
exports.getSetLocationHeaderMiddleware = locationHeader => (
  request,
  response,
  next
) => {
...
exports.setLocationHeaderMiddleware = exports.getSetLocationHeaderMiddleware(
  headers_1.SupportedResponseHeaders.location
);
exports.getSendFriendAddedSuccessMessageMiddleware = addFriendSuccessMessage => (
  request,
  response,
  next
) => {
...
const localisedSuccessfullyAddedFriendMessage = getLocalisedString_1.getLocalisedString(
  messageCategories_1.MessageCategories.successMessages,
  successMessages_1.SuccessMessageKeys.successfullyAddedFriend
);
exports.sendFriendAddedSuccessMessageMiddleware = exports.getSendFriendAddedSuccessMessageMiddleware(
