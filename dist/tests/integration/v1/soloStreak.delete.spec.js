...
describe(`DELETE ${soloStreakRoute}`, () => {
    ...
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const createSoloStreakResponse = yield request(app_1.default)
            ...
            .set({ [headers_1.SupportedRequestHeaders.xTimezone]: budapestTimezone });
    ...
    afterAll(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield AgendaJob_1.agendaJobModel.deleteOne({ "data.timezone": budapestTimezone });
    }));
    test(`that solo streak can be deleted`, () => __awaiter(this, void 0, void 0, function* () {
        expect.assertions(1);
        const response = yield request(app_1.default)
            .delete(`${soloStreakRoute}/${soloStreakId}`)
            .set({ [headers_1.SupportedRequestHeaders.xAccessToken]: jsonWebToken });
        expect(response.status).toEqual(responseCodes_1.ResponseCodes.deleted);
    }));
});
jest.setTimeout(30000);
//# sourceMappingURL=soloStreak.delete.spec.js.map