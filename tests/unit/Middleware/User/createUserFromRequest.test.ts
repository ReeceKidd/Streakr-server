import { createUserFromRequest } from "../../../../src/Middleware/User/createUserFromRequest";

const middlewareName = "createUserFromRequest";
...
describe(`${middlewareName}`, () => {
  it("should define response.locals.newUser", async () => {
    ...
    const middleware = createUserFromRequest(User)
