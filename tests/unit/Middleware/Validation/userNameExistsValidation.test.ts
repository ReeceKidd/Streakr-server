...
import {
  ...
  userNameKey
} from "../../../../src/Middleware/Validation/userNameExistsValidation";

const middlewareName = "userNameExistsValidation";
...
describe(`${middlewareName}`, () => {
  it("check that error response is returned correctly when userName already exists", () => {
    ...
    const middleware = userNameExistsValidation(generateAlreadyExistsMessage);
