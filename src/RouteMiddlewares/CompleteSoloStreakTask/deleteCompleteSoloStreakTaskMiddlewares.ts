...
export const getDeleteCompleteSoloStreakTaskMiddleware = (
    ...
    try {
        ...
        else next(new CustomError(ErrorType.DeleteCompleteSoloStreakTaskMiddleware, err));
    }
};
...
export const getSendCompleteSoloStreakTaskDeletedResponseMiddleware = (
    ...
    try {
        ...
        next(new CustomError(ErrorType.SendCompleteSoloStreakTaskDeletedResponseMiddleware, err));
    }
};
