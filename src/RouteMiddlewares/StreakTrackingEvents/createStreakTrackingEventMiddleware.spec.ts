...
describe(`createStreakTrackingEventBodyValidationMiddleware`, () => {
    ...
    test('sends correct correct response when type is incorrect', () => {
        ...
        expect(send).toBeCalledWith({
            message:
                'child "type" fails because ["type" must be one of [lostStreak, maintainedStreak, inactiveStreak, forcedToLoseStreakBecauseTeamMemberDidNotCompleteTask, recoveredStreak]]',
        });
