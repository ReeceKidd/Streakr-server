...
export const getFindFriendRequestsMiddleware = (friendRequestModel: mongoose.Model<FriendRequestModel>) => async (
    request: Request,
    response: Response,
    next: NextFunction,
): Promise<void> => {
...
export const findFriendRequestsMiddleware = getFindFriendRequestsMiddleware(friendRequestModel);

export const getPopulateFriendRequestsMiddleware = (userModel: mongoose.Model<UserModel>) => async (
    request: Request,
    response: Response,
    next: NextFunction,
): Promise<void> => {
...
export const populateFriendRequestsMiddleware = getPopulateFriendRequestsMiddleware(userModel);
