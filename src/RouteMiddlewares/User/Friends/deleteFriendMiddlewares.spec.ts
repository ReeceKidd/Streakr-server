...
describe('deleteFriendMiddlewares', () => {
    ...
    describe('retreiveUserMiddleware', () => {
        ...
        test('throws DeleteUserNoUserFound when user does not exist', async () => {
            ...
            expect(next).toBeCalledWith(new CustomError(ErrorType.DeleteUserNoUserFound));
        });
        ...
        test('throws DeleteUserRetreiveUserMiddleware error on middleware failure', async () => {
            ...
            expect(next).toBeCalledWith(new CustomError(ErrorType.DeleteUserRetreiveUserMiddleware, expect.any(Error)));
        });
    });
    ...
    describe('doesFriendExistMiddleware', () => {
        ...
        test('throws DeleteUserFriendDoesNotExist if the friend does not exist', () => {
            ...
            expect(next).toBeCalledWith(new CustomError(ErrorType.DeleteUserFriendDoesNotExist));
        });
        ...
        test('throws DeleteFriendDoesFriendExistMiddleware error on middleware failure', async () => {
            ...
            expect(next).toBeCalledWith(
                new CustomError(ErrorType.DeleteFriendDoesFriendExistMiddleware, expect.any(Error)),
            );
        });
    });
    ...
    describe('deleteFriendMiddleware', () => {
        ...
        test('calls next with DeleteFriendMiddleware on middleware failure', async () => {
            ...
            expect(next).toBeCalledWith(new CustomError(ErrorType.DeleteFriendMiddleware, expect.any(Error)));
        });
    });
    ...
    describe('sendUserDeletedResponseMiddleware', () => {
        ...
        test('that on error next is called with error', () => {
            ...
            expect(next).toBeCalledWith(
                new CustomError(ErrorType.SendUserDeletedResponseMiddleware, expect.any(Error)),
            );
        });
    });
