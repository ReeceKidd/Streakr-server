...
//     const middleware = getAddFriendMiddleware(UserModel as any);
...
//     const middleware = getRetreiveFriendsDetailsMiddleware(userModel as any);
//     await middleware(request, response, next);
...
//     const middleware = getDefineLocationPathMiddleware(
//       apiVersion,
//       userCategory,
//       friendsProperty
//     );
...
//     const middleware = getSetLocationHeaderMiddleware(
...
//     const middleware = getSendFriendAddedSuccessMessageMiddleware(
//       successMessage
//     );
//     middleware(request, response, next);
...
//     expect(addFriendMiddlewares[9]).toBe(
//       sendFriendAddedSuccessMessageMiddleware
//     );
//   });
// });
