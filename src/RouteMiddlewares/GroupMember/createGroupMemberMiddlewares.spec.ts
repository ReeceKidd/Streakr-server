...
describe('friendExistsMiddleware', () => {
    ...
    test('throws CreateGroupMemberFriendDoesNotExist when friend does not exist', async () => {
        ...
        expect(next).toBeCalledWith(new CustomError(ErrorType.CreateGroupMemberFriendDoesNotExist));
    });
    ...
    test('throws CreateGroupMemberTeamStreakExistsMiddleware error on middleware failure', async () => {
        ...
        expect(next).toBeCalledWith(
            new CustomError(ErrorType.CreateGroupMemberFriendExistsMiddleware, expect.any(Error)),
        );
    });
});
...
describe('teamStreakExistsMiddleware', () => {
    ...
    test('throws CreateGroupMemberTeamStreakDoesNotExist error when group streak does not exist', async () => {
        ...
        expect(next).toBeCalledWith(new CustomError(ErrorType.CreateGroupMemberTeamStreakDoesNotExist));
    });
    ...
    test('throws CreateGroupMemberTeamStreakExistsMiddleware error on middleware failure', async () => {
        ...
        expect(next).toBeCalledWith(
            new CustomError(ErrorType.CreateGroupMemberTeamStreakExistsMiddleware, expect.any(Error)),
        );
    });
});
...
describe(`createGroupMemberStreakMiddleware`, () => {
    ...
    test('calls next with CreateGroupMemberCreateGroupMemberStreakMiddleware error on middleware failure', () => {
        ...
        expect(next).toBeCalledWith(
            new CustomError(ErrorType.CreateGroupMemberCreateGroupMemberStreakMiddleware, expect.any(Error)),
        );
    });
});
...
describe(`sendCreateGroupMemberResponseMiddleware`, () => {
    ...
    test('calls next with SendFormattedGroupMemberMiddleware error on middleware failure', () => {
        ...
        expect(next).toBeCalledWith(
            new CustomError(ErrorType.SendCreateGroupMemberResponseMiddleware, expect.any(Error)),
        );
    });
});
...
describe(`createGroupMemberMiddlewares`, () => {
    test('are defined in the correct order', async () => {
        ...
        expect(createGroupMemberMiddlewares[0]).toBe(createGroupMemberParamsValidationMiddleware);
        expect(createGroupMemberMiddlewares[1]).toBe(createGroupMemberBodyValidationMiddleware);
        ...
        expect(createGroupMemberMiddlewares[4]).toBe(createGroupMemberStreakMiddleware);
        expect(createGroupMemberMiddlewares[5]).toBe(addFriendToTeamStreakMiddleware);
        expect(createGroupMemberMiddlewares[6]).toBe(sendCreateGroupMemberResponseMiddleware);
    });
});
