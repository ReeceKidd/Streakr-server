...
describe('patchSoloStreakMiddlewares', () => {
    ...
    describe(`decreaseUsersTotalLiveStreaksByOneWhenStreakIsArchivedMiddleware `, () => {
        ...
        test('calls next with PatchSoloStreakDecreaseUsersTotalLiveStreaksByOneWhenStreakIsArchivedMiddleware error on middleware failure', () => {
            expect.assertions(1);
    ...
    describe(`disableSoloStreakReminderWhenSoloStreakIsArchivedMiddleware`, () => {
        ...
        test('calls next with DisableSoloStreakReminderWhenSoloStreakIsArchivedMiddleware error on middleware failure', () => {
            ...
            expect(next).toBeCalledWith(
                new CustomError(
                    ErrorType.DisableSoloStreakReminderWhenSoloStreakIsArchivedMiddleware,
                    expect.any(Error),
                ),
            );
        });
    ...
    describe(`createEditedSoloStreakDescriptionActivityFeedItemMiddleware`, () => {
        ...
        test('calls next with CreateEditedSoloStreakDescriptionActivityFeedItemMiddleware error on middleware failure', () => {
            ...
            expect(next).toBeCalledWith(
                new CustomError(
                    ErrorType.CreateEditedSoloStreakDescriptionActivityFeedItemMiddleware,
                    expect.any(Error),
                ),
            );
        });
