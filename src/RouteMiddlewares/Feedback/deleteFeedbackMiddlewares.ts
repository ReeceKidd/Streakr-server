...
export const feedbackParamsValidationMiddleware = (request: Request, response: Response, next: NextFunction): void => {
    Joi.validate(
        request.params,
...
export const getDeleteFeedbackMiddleware = (feedbackModel: mongoose.Model<FeedbackModel>) => async (
    request: Request,
    response: Response,
    next: NextFunction,
): Promise<void> => {
...
export const deleteFeedbackMiddleware = getDeleteFeedbackMiddleware(feedbackModel);

export const getSendFeedbackDeletedResponseMiddleware = (successfulDeletetionResponseCode: ResponseCodes) => (
    request: Request,
    response: Response,
    next: NextFunction,
): void => {
...
export const sendFeedbackDeletedResponseMiddleware = getSendFeedbackDeletedResponseMiddleware(ResponseCodes.deleted);
