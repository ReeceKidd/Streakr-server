...
describe(`createFeedbackFromRequestMiddleware`, () => {
    ...
    test('calls next with CreateFeedbackFromRequestMiddleware error on middleware failure', () => {
        ...
        expect(next).toBeCalledWith(new CustomError(ErrorType.CreateFeedbackFromRequestMiddleware, expect.any(Error)));
    });
});
...
describe(`saveFeedbackToDatabaseMiddleware`, () => {
    ...
    test('calls next with SaveFeedbackToDatabaseMiddleware error on middleware failure', async () => {
        ...
        expect(next).toBeCalledWith(new CustomError(ErrorType.SaveFeedbackToDatabaseMiddleware, expect.any(Error)));
    });
});
...
describe(`sendFormattedFeedbackMiddleware`, () => {
    ...
    test('calls next with SendFormattedFeedbackMiddleware error on middleware failure', () => {
        ...
        expect(next).toBeCalledWith(new CustomError(ErrorType.SendFormattedFeedbackMiddleware, expect.any(Error)));
    });
});
...
describe(`createFeedbackMiddlewares`, () => {
    test('are defined in the correct order', async () => {
        ...
        expect(createFeedbackMiddlewares[0]).toBe(createFeedbackBodyValidationMiddleware);
        expect(createFeedbackMiddlewares[1]).toBe(createFeedbackFromRequestMiddleware);
