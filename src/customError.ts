...
export enum ErrorType {
    ...
    UnlockTotalimesTrackedAchievementForCompletingSoloStreakkMiddleware,
}
...
export class CustomError extends Error {
    ...
    private createCustomErrorData(type: ErrorType): { code: string; message: string; httpStatusCode: ResponseCodes } {
        switch (type) {
            ...
            case ErrorType.SaveTemporaryUserToDatabaseMiddleware:
                return {
                    code: `${ResponseCodes.warning}-439`,
                    message: internalServerMessage,
                    httpStatusCode: ResponseCodes.warning,
                };

            case ErrorType.RegisterTemporaryUserFormatUserMiddleware:
                return {
                    code: `${ResponseCodes.warning}-440`,
                    message: internalServerMessage,
                    httpStatusCode: ResponseCodes.warning,
                };
            ...
            case ErrorType.UpdateTeamStreakTeamMemberStreaksStatusMiddleware:
                return {
                    code: `${ResponseCodes.warning}-549`,
                    message: internalServerMessage,
                    httpStatusCode: ResponseCodes.warning,
                };

            case ErrorType.UnlockTotalimesTrackedAchievementForCompletingSoloStreakkMiddleware:
                return {
                    code: `${ResponseCodes.warning}-550`,
                    message: internalServerMessage,
                    httpStatusCode: ResponseCodes.warning,
                };
